...
export default function SettingsComponent({toogle,Props,onTogglePress,leftTitle,rightTitle,onPress,style,titleStyle,activeStyle,trackBar,colors,title,value}){
