            ...
            <View style={{flexDirection:'row',justifyContent:"space-between",alignItems:'center'}}>
                {isBack ?
                    ...
                    <View style={{justifyContent:'space-between',paddingBottom:10}}>
                        ...
                        <View style={{height:15,paddingHorizontal:25,zIndex:-2,right:-10,backgroundColor:"#fff"}}/>
                    ...
                    <View style={{marginHorizontal:20}}>
                        ...
                        <Text style={{color: "#000", fontSize: 16,paddingHorizontal:15,borderRadius:20,backgroundColor:"#fff", fontFamily: Constants.fontFamilyRegular}}>{userData?.Designation}</Text>
                    </View>
                }
