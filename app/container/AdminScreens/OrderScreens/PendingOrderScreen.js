...
export const PendingOrderScreen = (props) => {
    ...
    return (
        <View style={{flex: 1, backgroundColor: Color.primary}}>
            <View style={{paddingHorizontal: 20, marginVertical: 40, flexDirection: "row", alignItems: "center"}}>
                <HeaderComponent back={true} title={"Pending Orders"}/>
            </View>
            <View style={{
                flex: 1,
                ...
                <View style={{marginBottom: 20}}>
                    <FlatList ListEmptyComponent={
                        <View style={{flex: 1, alignItems: "center", justifyContent: "center"}}>
                            <Text style={{fontSize: 14, fontFamily: Constants.fontFamilyRegular, color: "#000"}}>You
                                Have No
                                Pending Orders Yet..!</Text>
                        </View>} refreshing={loading} onRefresh={() => {
                        GetData()
                    }} data={data} showsVerticalScrollIndicator={true}
                              contentContainerStyle={{flex: 1, paddingTop: 10, marginBottom: 20}}
