...
export const AdminDashboard = () => {
    ...
    const services = [{
        ...
        navigation: "PickedUpOrders",
    }, {title: "Ironing", image: require('../../images/iron.png'), navigation: "PickedUpOrders"}, {
        title: "Dry Cleaning",
    ...
    return (
        <ScrollView contentContainerStyle={{flex: 1}} style={{flex: 1, backgroundColor: Color.primary}}>
            ...
            <View style={{
                ...
                <View>
                    <FlatList showsHorizontalScrollIndicator={false} style={{marginLeft: 20,}} horizontal={true}
                              data={services} renderItem={({item, index}) =>
                ...
                <FlatList style={{marginHorizontal: 20}} contentContainerStyle={{paddingBottom: 20}}
