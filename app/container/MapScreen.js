                    ...
                    <View style={{backgroundColor: colors.screenBackgroundColor, borderRadius: 10, margin:30}}>
                        ...
                        <View style={{}}>
                            ...
                            <View style={{borderBottomWidth:1,borderBottomColor:colors.languageTextColor}}></View>
                             ...
                             <ButtonComponent onPress={()=>{this.state.From=="JobScreen"?this.props.navigation.navigate("RateAndReviewScreen"):null}}  title={this.state.From=="JobScreen"?t("L:Arrive"):t("L:Direction")} Style={{backgroundColor:colors.blackToGreen,marginHorizontal:40}} titleStyle={{color:"#fff"}}/>
                        </View>
                    </View>
